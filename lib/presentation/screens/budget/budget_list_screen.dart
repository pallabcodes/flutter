...
class BudgetListScreen extends ConsumerWidget {
            ...
            child: ScopedErrorBoundary(
              ...
              child: budgetsAsync.when(
                ...
                data: (budgets) => budgets.isEmpty
                    ...
                    : ScopedErrorBoundary(
                        scopeName: 'Budget Cards',
                        fallback: const Center(
                          child: Text('Unable to display budget cards'),
                        ),
                        child: _buildBudgetsList(context, budgets, ref),
                      ),
              ),
            ),
          ),
  ...
  void _showBudgetDetails(BuildContext context, budget) {
    AppRouter.goToBudgetDetails(budget);
  }
}
