  ...
  Future<Either<Failure, AuthUser>> signInWithFacebook() async {
    try {
      ...
      if (result.status == LoginStatus.failed) {
        return Left(UnexpectedFailure.withMessage('Facebook login failed: ${result.message}'));
      }
      ...
      return Left(UnexpectedFailure.withMessage('Facebook sign in failed: ${e.toString()}'));
    }
  }
